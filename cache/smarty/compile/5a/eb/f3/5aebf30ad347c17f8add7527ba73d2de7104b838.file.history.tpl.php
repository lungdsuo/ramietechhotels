<?php /* Smarty version Smarty-3.1.19, created on 2019-10-21 12:58:14
         compiled from "/var/www/html/ramietechhotels/themes/hotel-reservation-theme/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14859024705dadab664db799-53923987%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5aebf30ad347c17f8add7527ba73d2de7104b838' => 
    array (
      0 => '/var/www/html/ramietechhotels/themes/hotel-reservation-theme/history.tpl',
      1 => 1561817458,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14859024705dadab664db799-53923987',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dadab6651eb19_04597780',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dadab6651eb19_04597780')) {function content_5dadab6651eb19_04597780($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/var/www/html/ramietechhotels/tools/smarty/plugins/modifier.regex_replace.php';
?>
								...
								<?php if (isset($_smarty_tpl->tpl_vars['order_refund_info']->value[$_smarty_tpl->tpl_vars['order']->value['id_order']])) {?>
									<?php if (isset($_smarty_tpl->tpl_vars['order_refund_info']->value[$_smarty_tpl->tpl_vars['order']->value['id_order']]['waitting'])&&$_smarty_tpl->tpl_vars['order_refund_info']->value[$_smarty_tpl->tpl_vars['order']->value['id_order']]['waitting']) {?>
										<p class="ref_req_wait">
											<?php echo smartyTranslate(array('s'=>"Waiting Requests"),$_smarty_tpl);?>
 : <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['order']->value['id_order'];?>
<?php $_tmp55=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['order_refund_info']->value[$_tmp55]['waitting'];?>
 ...
 : <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['order']->value['id_order'];?>
<?php $_tmp56=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['order_refund_info']->value[$_tmp56]['accepted'];?>
 ...
 : <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['order']->value['id_order'];?>
<?php $_tmp57=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['order_refund_info']->value[$_tmp57]['rejected'];?>
 ...
 : <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['order']->value['id_order'];?>
<?php $_tmp58=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['order_refund_info']->value[$_tmp58]['refunded'];?>
...
<?php $_tmp59=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".$_tmp59), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php } else { ?>
								<a class="link-button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp60=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".$_tmp60), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>
