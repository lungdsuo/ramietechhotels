<?php /* Smarty version Smarty-3.1.19, created on 2019-10-21 12:58:14
         compiled from "/var/www/html/ramietechhotels/themes/hotel-reservation-theme/guest-tracking.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6972600405dadab6644d033-26940648%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd3f1d08ae16f1a420d58541fce9260604583c546' => 
    array (
      0 => '/var/www/html/ramietechhotels/themes/hotel-reservation-theme/guest-tracking.tpl',
      1 => 1561817458,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6972600405dadab6644d033-26940648',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dadab6647bc85_57889088',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dadab6647bc85_57889088')) {function content_5dadab6647bc85_57889088($_smarty_tpl) {?>
...
?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['transformSuccess']->value)) {?>
		<p class="alert alert-success"><?php echo smartyTranslate(array('s'=>'Your guest account has been successfully transformed into a customer account. You can now log in as a registered user. '),$_smarty_tpl);?>
...
#guestToCustomer" class="std">
			<fieldset class="description_box box">
				...
				<ul>
					...
					<li> - <?php echo smartyTranslate(array('s'=>'Easier refund process'),$_smarty_tpl);?>
</li>
				</ul>
                <div class="row">
...
<?php } else { ?><?php if (isset($_POST['id_order'])) {?><?php echo htmlspecialchars($_POST['id_order'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?><?php }?>" size="8" />
                        <i><?php echo smartyTranslate(array('s'=>'For example: QIIXJXNUI'),$_smarty_tpl);?>
</i>
                    </div>
                    <div class="text form-group">
