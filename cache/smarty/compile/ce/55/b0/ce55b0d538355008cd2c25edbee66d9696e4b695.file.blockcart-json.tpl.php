<?php /* Smarty version Smarty-3.1.19, created on 2019-10-21 12:58:13
         compiled from "/var/www/html/ramietechhotels/themes/hotel-reservation-theme/modules/blockcart/blockcart-json.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10611920365dadab65a20a22-96287535%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ce55b0d538355008cd2c25edbee66d9696e4b695' => 
    array (
      0 => '/var/www/html/ramietechhotels/themes/hotel-reservation-theme/modules/blockcart/blockcart-json.tpl',
      1 => 1561817458,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10611920365dadab65a20a22-96287535',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dadab65a5d0d5_19034351',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dadab65a5d0d5_19034351')) {function content_5dadab65a5d0d5_19034351($_smarty_tpl) {?>
{
"products": [
...
,
		"total_product_price": <?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value==@constant('PS_TAX_EXC')) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode(floatval($_smarty_tpl->tpl_vars['product']->value['total']));?>
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode(floatval($_smarty_tpl->tpl_vars['product']->value['total_wt']));?>
<?php }?>,
...
,
"totalToPay": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode(floatval($_smarty_tpl->tpl_vars['totalToPay']->value));?>
,
...
,
"totalDemandsPrice": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->tpl_vars['total_extra_demands']->value);?>
,
"totalDemandsPriceFormat": <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->tpl_vars['total_extra_demands_format']->value);?>
,
