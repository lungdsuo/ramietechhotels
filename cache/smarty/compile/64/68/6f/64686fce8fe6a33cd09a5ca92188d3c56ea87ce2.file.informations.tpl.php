<?php /* Smarty version Smarty-3.1.19, created on 2019-10-21 12:58:13
         compiled from "/var/www/html/ramietechhotels/admin/themes/default/template/controllers/products/informations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12987028945dadab657258d0-22444624%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '64686fce8fe6a33cd09a5ca92188d3c56ea87ce2' => 
    array (
      0 => '/var/www/html/ramietechhotels/admin/themes/default/template/controllers/products/informations.tpl',
      1 => 1561817458,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12987028945dadab657258d0-22444624',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dadab657812f3_29055614',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dadab657812f3_29055614')) {function content_5dadab657812f3_29055614($_smarty_tpl) {?>
...
<div id="product-informations" class="panel product-tab">
	...
	<script type="text/javascript">
		...
		var msg_select_one = "<?php echo smartyTranslate(array('s'=>'Please select at least one room type.','js'=>1),$_smarty_tpl);?>
";
		var msg_set_quantity = "<?php echo smartyTranslate(array('s'=>'Please set a quantity to add a room type.','js'=>1),$_smarty_tpl);?>
";
...
&updateproduct&id_product='+data.id_product;
	...
	<div class="alert alert-warning" style="display: block"><?php echo smartyTranslate(array('s'=>'Warning, if you change the value of fields with an orange bullet %s, the value will be changed for all other shops for this room type','sprintf'=>$_smarty_tpl->tpl_vars['bullet_common_field']->value),$_smarty_tpl);?>
</div>
	<?php }?>
...
">
			<span class="label-tooltip" data-toggle="tooltip" title="<?php echo smartyTranslate(array('s'=>'Write the name of the Room Type for ex. Delux, Executive etc.'),$_smarty_tpl);?>
 ...
 &lt;&gt;;=#{}">
		...
		<div class="col-lg-5">
			<?php ob_start();?><?php if (!$_smarty_tpl->tpl_vars['product']->value->id||Configuration::get('PS_FORCE_FRIENDLY_PRODUCT')) {?><?php echo "copy2friendlyUrl";?><?php }?><?php $_tmp11=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("controllers/products/input_text_lang.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('languages'=>$_smarty_tpl->tpl_vars['languages']->value,'input_class'=>((string)$_smarty_tpl->tpl_vars['class_input_ajax']->value).$_tmp11." updateCurrentText",'input_value'=>$_smarty_tpl->tpl_vars['product']->value->name,'input_name'=>"name",'required'=>true), 0);?>
	...
	<div class="form-group hidden">
		<label class="control-label col-lg-3" for="reference">
			...
			title="<?php echo smartyTranslate(array('s'=>'Your internal reference code for this room type.'),$_smarty_tpl);?>
...
" />
	...
	<div class="form-group hidden">
		<label class="control-label col-lg-3" for="ean13">
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'This type of room type code is specific to Europe and Japan, but is widely used internationally. It is a superset of the UPC code: all products marked with an EAN will be accepted in North America.'),$_smarty_tpl);?>
">
				<?php echo $_smarty_tpl->tpl_vars['bullet_common_field']->value;?>
...
" />
	...
	<div class="form-group hidden">
		<label class="control-label col-lg-3" for="upc">
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'This type of room type code is widely used in the United States, Canada, the United Kingdom, Australia, New Zealand and in other countries.'),$_smarty_tpl);?>
">
				<?php echo $_smarty_tpl->tpl_vars['bullet_common_field']->value;?>
...
<br/>
				<?php echo smartyTranslate(array('s'=>'301 Moved Permanently = Permanently display another room type instead.'),$_smarty_tpl);?>
<br/>
				<?php echo smartyTranslate(array('s'=>'302 Moved Temporarily = Temporarily display another room type instead.'),$_smarty_tpl);?>
...
">
			<span class="label-tooltip" data-toggle="tooltip" title="<?php echo smartyTranslate(array('s'=>'Appears in the room type list(s), and at the top of the room type page.'),$_smarty_tpl);?>
">
...
">
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'Appears in the body of the room type.'),$_smarty_tpl);?>
">
...
">
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'Will be displayed in the tags block when enabled. Tags help customers easily find your room types.'),$_smarty_tpl);?>
">
...
<script type="text/javascript">
	...
	var missing_product_name = '<?php echo smartyTranslate(array('s'=>'Please fill room type name input field','js'=>1),$_smarty_tpl);?>
';
</script>
<?php }} ?>
