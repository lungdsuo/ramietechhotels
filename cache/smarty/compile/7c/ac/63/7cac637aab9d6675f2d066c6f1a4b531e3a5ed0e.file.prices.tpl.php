<?php /* Smarty version Smarty-3.1.19, created on 2019-10-21 12:58:13
         compiled from "/var/www/html/ramietechhotels/admin/themes/default/template/controllers/products/prices.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9014806175dadab658637b3-50357417%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7cac637aab9d6675f2d066c6f1a4b531e3a5ed0e' => 
    array (
      0 => '/var/www/html/ramietechhotels/admin/themes/default/template/controllers/products/prices.tpl',
      1 => 1561817458,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9014806175dadab658637b3-50357417',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dadab658f37c0_06688972',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dadab658f37c0_06688972')) {function content_5dadab658f37c0_06688972($_smarty_tpl) {?>
...
<div id="product-prices" class="panel product-tab">
	...
	<h3><?php echo smartyTranslate(array('s'=>'Room type price'),$_smarty_tpl);?>
</h3>
...
<?php $_tmp12=ob_get_clean();?><?php echo sprintf($_smarty_tpl->tpl_vars['priceDisplayPrecisionFormat']->value,$_tmp12);?>
...
<?php $_tmp13=ob_get_clean();?><?php echo smartyTranslate(array('s'=>'The sum of wholesale prices of the room types in the pack is %s%s%s','sprintf'=>array($_smarty_tpl->tpl_vars['currency']->value->prefix,$_tmp13,$_smarty_tpl->tpl_vars['currency']->value->suffix)),$_smarty_tpl);?>
</p><?php }?>
		</div>
	</div>
	<div class="form-group">
		...
		<label class="control-label col-lg-2" for="priceTE">
			<span class="label-tooltip" data-toggle="tooltip" title="<?php echo smartyTranslate(array('s'=>'The pre-tax retail price is the price for which you intend sell this room type to your customers. It should be higher than the pre-tax wholesale price: the difference between the two will be your margin.'),$_smarty_tpl);?>
...
<?php $_tmp14=ob_get_clean();?><?php echo sprintf('%.6f',$_tmp14);?>
...
<?php $_tmp15=ob_get_clean();?><?php echo smartyTranslate(array('s'=>'The sum of prices of the room types in the pack is %s%s%s','sprintf'=>array($_smarty_tpl->tpl_vars['currency']->value->prefix,$_tmp15,$_smarty_tpl->tpl_vars['currency']->value->suffix)),$_smarty_tpl);?>
</p><?php }?>
	</div>
...
"<?php }?>>
				<span class="label-tooltip" data-toggle="tooltip" title="<?php echo smartyTranslate(array('s'=>'If Disabled, Advance payment will not apply on this room type.'),$_smarty_tpl);?>
">
					<?php echo smartyTranslate(array('s'=>'Allow Advance Payment'),$_smarty_tpl);?>
		...
		<div class="form-group adv_payment_field">
			...
			<label class="control-label col-sm-2">
				<span class="label-tooltip" data-toggle="tooltip" title="<?php echo smartyTranslate(array('s'=>'If disabled, Advance Payment for the room type will be calculated By Global Advance payment settings.'),$_smarty_tpl);?>
">
					<?php echo smartyTranslate(array('s'=>'Apply Room Type Advance Payment Setting.'),$_smarty_tpl);?>
...
<?php $_tmp16=ob_get_clean();?><?php echo sprintf('%.6f',$_tmp16);?>
<?php }?>"/>
						</div>
					</div>
				</div>
		...
		<div class="form-group adv_payment_field">
			...
			<label class="control-label col-sm-2">
				<span class="label-tooltip" data-toggle="tooltip" title="<?php echo smartyTranslate(array('s'=>'If Enable, customer will pay : (Advanced payment price + tax) and if Disabled, customer will only pay advanced payment price'),$_smarty_tpl);?>
">
					<?php echo smartyTranslate(array('s'=>'Include tax'),$_smarty_tpl);?>
...
%
							...
							<td>
								<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['dateFormat'][0][0]->dateFormat(array('date'=>$_smarty_tpl->tpl_vars['featurePlan']->value['date_from'],'full'=>0),$_smarty_tpl);?>

							</td>
							<td>
								<?php if ($_smarty_tpl->tpl_vars['featurePlan']->value['date_selection_type']==1) {?>
									<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['dateFormat'][0][0]->dateFormat(array('date'=>$_smarty_tpl->tpl_vars['featurePlan']->value['date_to'],'full'=>0),$_smarty_tpl);?>

								<?php } else { ?>
									<span class="badge badge-success"><?php echo smartyTranslate(array('s'=>'Specific date'),$_smarty_tpl);?>
</span>
								<?php }?>
							</td>
...
"><?php echo $_smarty_tpl->tpl_vars['combination']->value['attributes'];?>
			...
			<div class="form-group">
				<label class="control-label col-lg-2" for="sp_price"><?php echo smartyTranslate(array('s'=>'Room type price'),$_smarty_tpl);?>
