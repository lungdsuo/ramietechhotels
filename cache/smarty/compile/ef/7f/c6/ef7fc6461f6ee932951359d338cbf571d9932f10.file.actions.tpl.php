<?php /* Smarty version Smarty-3.1.19, created on 2019-10-21 12:58:13
         compiled from "/var/www/html/ramietechhotels/admin/themes/default/template/controllers/cart_rules/actions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:959542465dadab655c1a32-51179917%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ef7fc6461f6ee932951359d338cbf571d9932f10' => 
    array (
      0 => '/var/www/html/ramietechhotels/admin/themes/default/template/controllers/cart_rules/actions.tpl',
      1 => 1561817458,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '959542465dadab655c1a32-51179917',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5dadab655e72b3_17182197',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5dadab655e72b3_17182197')) {function content_5dadab655e72b3_17182197($_smarty_tpl) {?><div class="form-group hidden">
	...
	<div class="col-lg-7">
		...
		<p class="radio">
			<label for="apply_discount_to_product">
				...
				<?php echo smartyTranslate(array('s'=>'Specific Room type'),$_smarty_tpl);?>
		...
		<p class="radio">
			<label for="apply_discount_to_cheapest">
				<input type="radio" name="apply_discount_to" id="apply_discount_to_cheapest" value="cheapest"<?php if (intval($_smarty_tpl->tpl_vars['currentTab']->value->getFieldValue($_smarty_tpl->tpl_vars['currentObject']->value,'reduction_product'))==-1) {?> checked="checked"<?php }?> />
				 <?php echo smartyTranslate(array('s'=>'Cheapest Room type'),$_smarty_tpl);?>
		...
		<p class="radio">
			<label for="apply_discount_to_selection">
				...
				<?php echo smartyTranslate(array('s'=>'Selected Room Type(s)'),$_smarty_tpl);?>
<?php if (count($_smarty_tpl->tpl_vars['product_rule_groups']->value)==0) {?>&nbsp;<span id="apply_discount_to_selection_warning" class="text-muted clearfix"><i class="icon-warning-sign"></i> <a href="#" id="apply_discount_to_selection_shortcut"><?php echo smartyTranslate(array('s'=>'You must select some room types before'),$_smarty_tpl);?>
</a></span><?php }?>
			</label>
		</p>
	</div>
...
<div id="apply_discount_to_product_div" class="form-group">
	<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Room Type'),$_smarty_tpl);?>
</label>
	<div class="col-lg-9">
